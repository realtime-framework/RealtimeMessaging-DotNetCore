...
using RT.Ortc.Plugin.RealTimeSJ.WS;

namespace RT.Ortc.Plugin.RealTimeSJ
{
    /// <summary>
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        public override void Presence(String channel, OnPresenceDelegate callback)
        {
            ...
            Api.Extensibility.Presence.GetPresence(url, isCluster, this._applicationKey, this._authenticationToken, channel, callback);
        }
        ...
        public override void EnablePresence(String privateKey, String channel, bool metadata, OnEnablePresenceDelegate callback)
        {
            ...
            Api.Extensibility.Presence.EnablePresence(url, isCluster, this._applicationKey, privateKey, channel, metadata, callback);
        }
        ...
        public override void DisablePresence(String privateKey, String channel, OnDisablePresenceDelegate callback)
        {
            ...
            Api.Extensibility.Presence.DisablePresence(url, isCluster, this._applicationKey, privateKey, channel, callback);
        }
