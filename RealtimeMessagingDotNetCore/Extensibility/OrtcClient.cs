...
namespace RT.Ortc.Api.Extensibility
{
    ...
    /// 
    ///         // Save authentication
    ///         bool authSaved = RT.Ortc.Api.Ortc.SaveAuthentication(url, isCluster, authenticationToken, authenticationTokenIsPrivate, applicationKey, timeToLive, privateKey, permissions)) 
    ///         
    ///         // Load factory
